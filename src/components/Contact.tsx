...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 relative">
      <div className="absolute bottom-40 right-0 w-80 h-80 bg-neon-green/10 rounded-full blur-3xl -z-10" />
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {formStatus.isSubmitted && (
                <div className={`text-sm ${formStatus.isError ? 'text-red-500' : 'text-green-500'}`}>
                  {formStatus.message}
                </div>
              )}
